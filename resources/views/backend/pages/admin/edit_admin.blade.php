...
{{-- <div class="row p-4 pt-5">
            ...
            <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title"><i class="fas fa-user-plus fa-2x"></i> Formulaire de modification de l'utilisateur</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                  ...
                  <input type="hidden" name="id" value="{{$item->id}}">
                    <div class="card-body">
                      <div class="d-flex">
                          <div class="form-group flex-grow-1 mr-2">
                              <label >Nom</label>
                              <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="KAFANDO" value="{{$item->name}}">
                          ...
                          <div class="form-group flex-grow-1 mr-2">
                              <label >Prenom</label>
                              <input type="text" name="surname" class="form-control @error('surname') is-invalid @enderror" name="surname" placeholder="Moussa" value="{{$item->surname}}">
                     ...
                     <div class="row">
                        ...
                        {{-- <div class="col-4">
                            <div class="form-group">
                                ...
                                <select name="roles" class="form-control @error('group_name') is-invalid @enderror" id="exampleFormControlSelect1">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                <label for="exampleInputUsername1">Profil</label>
                                <select name="roles" class="form-control @error('group_name') is-invalid @enderror" id="exampleFormControlSelect1">
                                    <option value="" disabled>Sélectionner un rôle</option>
                                    @foreach ($roles as $role)
                                    <option value="{{ $role->id }}" {{ $item->hasRole($role->name) ? 'selected' : '' }}>{{ $role->name }}</option>                                    @endforeach
                                </select>
                                @error('group_name')
                    ...
                    <div class="d-flex">
                          <div class="form-group flex-grow-1 mr-2">
                              ...
                              <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" maxlength="8" placeholder="52132865" value="{{$item->phone}}">
                              @error("phone")
                                  <span class="text-danger">{{ $message }}</span>
                              @enderror
                          </div>
                          <div class="form-group flex-grow-1 mr-2">
                              ...
                              <input type="text" class="form-control" name="phone2" maxlength="8" placeholder="52132865" value="{{$item->phone2}}">
                          </div>

                          <div class="form-group flex-grow-1">
                            <label >Numéro de piece d'identité</label>
                            <input type="text" class="form-control @error('numeroPieceIdentite') is-invalid @enderror" name="numeroPieceIdentite" maxlength="12" value="{{$item->numeroPieceIdentite}}">
