          ...
          <table class="table table-head-fixed">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center"><span class="tag tag-success">{{ $item->created_at }}</span></td>
                <td>{{$item->email}}</td>
                <td>
                    @if ($item->role)
                  ...
                  <div class="modal-dialog modal-xl" role="document">
                      <div class="modal-content">
                          ...
                          <div class="modal-body">
                              <div class="card">
                                  <div class="card-body">
                                      @include("backend.pages.admin.edit_admin")
              ...
              <a href="{{route('admin.roles.delete.admin',$item->id)}}" class="btn btn-danger"
                          ...
                          <div class="modal-body">
                              ...
                              <div class="card">
                                  <div class="card-body">
                                      ...
                                      @include("backend.pages.admin.info")
