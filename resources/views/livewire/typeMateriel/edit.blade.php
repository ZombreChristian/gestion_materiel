    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edition d'un equipement </h5>
                ...
                <div class="d-flex">
                        <div class=" my-4 bg-gray-light p-3 flex-grow-1">
                            ...
                            <div class="form-group">
                                ...
                                <select  class="form-control" wire:model="editArticle.type_materiel_id">
                            ...
                            <div class="my-3 bg-gray-light">
                                @foreach($editArticle["article_proprietes"] as $index => $materielProprietaire)
                                    <div class="form-group">
                                        <label for=""> {{$materielProprietaire["propriete"]["nom"]}} @if(!$materielProprietaire["propriete"]["estObligatoire"]) (optionel) @endif
                                        </label>
