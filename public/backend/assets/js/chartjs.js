$(function() {
  ...
  if($('#chartjsBar').length) {
    new Chart($("#chartjsBar"), {
        type: 'bar',
        data: {
            labels: types, // Utilisez les types comme libellés
            datasets: [
                {
                    label: "",
                    backgroundColor: colors.slice(0, types.length), // Utilisez des couleurs personnalisées
                    data: quantites
                }
            ]
        },
    ...
    new Chart($('#chartjsPie'), {
        type: 'pie',
                data: {
                    ...
                    datasets: [{
                        label: "Population (millions)",
                        backgroundColor: colors.slice(0, labels.length), // Utilisez des couleurs personnalisées
                        data: data
                    }]
                }
    });
